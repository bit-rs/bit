...
impl<'pkg, 'cx> ModuleCx<'pkg, 'cx> {
    ...
    fn infer_function_type_path(
        ...
        let params = params
            ...
            .collect();
        let ret = Box::new(ret.map_or(Typ::Unit, |t| self.infer_type_annotation(*t)));
    ...
    pub(crate) fn infer_type_annotation(&mut self, path: TypePath) -> Typ {
        match path.clone() {
            ...
            TypePath::Function { params, ret, .. } => self.infer_function_type_path(params, ret),
